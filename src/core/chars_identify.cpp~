...
namespace easypr {
	...
	CharsIdentify::CharsIdentify() {
		...
		BufferFile json_data("./models/lenet.json");
		BufferFile param_data("./models/chars_lenet-0-0100.params");
		...
		/* Chinese recog*/
		// Models path for your model, you have to modify it
		BufferFile json_data2("./models/lenet_zh.json");
		BufferFile param_data2("./models/charsZH_lenet-0-0100.params");
